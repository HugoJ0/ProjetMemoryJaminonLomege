...
public class Niveau2 extends AppCompatActivity {
    ...
    Button rouge,vert,bleu,jaune,orange;
    Button start;
    Button retour;
    List<Integer> ordi;
    List<Button> boutons;
    ...
    private void nouvelleEtape(){
        if(vivant){
            if(etape>nbFinBloc){
                ...
                Toast.makeText(Niveau2.this,"Bravo! Vous avez passer le niveau 2, vous gagnez "+score+" points", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Niveau2.this,Niveau3.class);
            ...
            Toast.makeText(Niveau2.this,"Perdu, vous recommencez le niveau!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Niveau2.this,Niveau2.class);
