...
public class Niveau4 extends AppCompatActivity {
    ...
    Button rouge,vert,bleu,jaune,orange,pink,cyan;
    Button start;
    Button retour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Niveau4.this, Menu.class);
    ...
    private void nouvelleEtape(){
        if(vivant){
            if(etape>nbFinBloc){
                ...
                Toast.makeText(Niveau4.this,"Bravo! Vous avez passer le niveau 4, vous gagnez "+score+" points", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Niveau4.this,Niveau5.class);
            ...
            Toast.makeText(Niveau4.this,"Perdu, vous recommencez le niveau!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Niveau4.this,Niveau4.class);
